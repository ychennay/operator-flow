# Prerequisites to Using OperatorFlow API Gateway as a Proxy Server

**Note: For full transparency, the following documentation, along with all of the code in this module, was auto-generated by AWS when I exported my
API Gateway's SDK.**
